...
public class SerilizationTests {
    ...
    public void test_save_then_load() throws IOException {
        ...
        entityList.add(new City(new Coordinate(39, 42), 0, new SimpleIntegerProperty(3), Nationality.Enemy, false,
    ...
    public void test_multipleCity() throws IOException {
        ...
        entityList.add(new City(new Coordinate(39, 42), 0, new SimpleIntegerProperty(3), Nationality.Enemy, false,
                CityType.Standard, game));
        entityList.add(new City(new Coordinate(290, 270), 0, new SimpleIntegerProperty(9), Nationality.Player, true,
                CityType.Fast, game));
        entityList.add(new City(new Coordinate(23, 32), 0, new SimpleIntegerProperty(31), Nationality.Neutral, false,
